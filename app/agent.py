...
class ProductionAgent:
    ...
    - Retry on failure (mdoel fallback)
    ...
    def __init__(self):
        ...
        self.primary_llm = ChatGroq(
            ...
            temperature = 0.3,
            timeout= 30,
            max_retries = 0, # We handle retiries ourselves
    ...
    def _build_graph(self):
        ...
        def handle_error(state: AgentState)->dict:
             ...
             return {
                  'messages':[
                       AIMessage(content = ("I'm sorry, I'm having trouble processing your request right noe, Please try again in a moment. Thanks!"))
                  ],
